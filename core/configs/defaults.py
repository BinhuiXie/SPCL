...
_C.DATASETS.TEST = ""
# List of the transferred dataset names for training
_C.DATASETS.SOURCE_STYLE = ""
...
_C.SOLVER.GAMMA = 0.1
_C.SOLVER.LAMBDA_ADV_TARGET = 0.001
