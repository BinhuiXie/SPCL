    ...
    def __call__(self, img, lab):
        if self.padding is not None:
            ...
            if isinstance(lab, np.ndarray):
                lab = np.pad(lab, ((self.padding[1], self.padding[3]), (self.padding[0], self.padding[2]), (0, 0)),
                             mode='constant')
            else:
        ...
        if self.pad_if_needed and img.size[0] < self.size[1]:
            ...
            if isinstance(lab, np.ndarray):
                lab = np.pad(lab, ((0, 0), (self.size[1] - img.size[0], self.size[1] - img.size[0]), (0, 0)),
                             mode='constant')
            else:
        ...
        if self.pad_if_needed and img.size[1] < self.size[0]:
            ...
            if isinstance(lab, np.ndarray):
                lab = np.pad(lab, ((self.size[0] - img.size[1], self.size[0] - img.size[1]), (0, 0), (0, 0)),
                             mode='constant')
            else:
